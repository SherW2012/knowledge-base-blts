...
| 标准 | 常见工作频段 | 理论最高速率（常见考法） |
| --- | --- | ---: |
| IEEE 802.11 | 2.4 GHz | 2 Mb/s |
| IEEE 802.11b | 2.4 GHz | 11 Mb/s |
| IEEE 802.11a | 5 GHz | 54 Mb/s |
| IEEE 802.11g | 2.4 GHz | 54 Mb/s |
| IEEE 802.11n | 2.4 GHz / 5 GHz | 600 Mb/s |

其中，IEEE 802.11b规定的传输速率档位为：**1 Mb/s、2 Mb/s、5.5 Mb/s、11 Mb/s**。

> 记忆：802.11b看见“5.5”和“11”；802.11a、802.11g的最高速率都是54 Mb/s。
